...
class _$_MainState implements _MainState {
  _$_MainState({this.count = 0, this.isLoading = false});
  ...
  @override
  String toString() {
    return 'MainState(count: $count, isLoading: $isLoading)';
  }
...
abstract class _MainState implements MainState {
  factory _MainState({final int count, final bool isLoading}) = _$_MainState;
